# Source: https://github.com/parisots/population-gcn/blob/master/ABIDEParser.py
...
def get_networks(subject_list, kind, atlas_name="aal", variable='connectivity'):
    ...
    norm_networks = [np.arctanh(mat) for mat in all_networks] # TODO: devide by zero
